...
export const api = {
  ...
  getRestaurantReviews: (restaurantId) => request(`/orders/restaurant/${restaurantId}/reviews`),
  replyToRating: (ratingId, replyText) => request(`/orders/ratings/${ratingId}/reply`, { method: 'PATCH', body: { replyText }, auth: true }),
  getMyComplaints: () => request('/orders/complaints/restaurant/mine', { auth: true }),
